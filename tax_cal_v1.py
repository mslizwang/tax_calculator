...
#根据月份，确定每月的累计应税额
def tax(month, income, tax_free_income, security_n_fund, tax_threshold, special_deduction, other_deduction):
...
#print tax(12,10000,0,449.4,5000,0,0)
...
print tax(month, income, tax_free_income, security_n_fund, 5000, special_deduction, other_deduction)
